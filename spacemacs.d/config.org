...
#+END_SRC
**** Spotify
[[https://github.com/syl20bnr/spacemacs/tree/master/layers/%252Bweb-services/spotify][docs]]
#+BEGIN_SRC emacs-lisp
spotify
#+END_SRC
...
#+END_SRC
** Web-Beautify
Basically ensures that syntax highlighting is refreshed for react files
From [[https://github.com/yasuyk/web-beautify/pull/29][this]] PR
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** React
as per [[https://github.com/syl20bnr/spacemacs/tree/master/layers/%252Bframeworks/react][docs]]
#+BEGIN_SRC emacs-lisp
(setq-default
 ;; js2-mode
 js2-basic-offset 2
